...
function Footer() {
  return (
      <footer className="h-[15vh] w-full bg-[#1F1D39] text-white' flex items-center">
        <div className="flex items-center ml-5 space-x-3 text-white">
          <Logo width="45px" />
          <span className="text-sm">&copy; 2025 All rights reserved</span>
        </div>
        <div className="flex-grow" />

        <ul className="flex w-[27%] mr-9 justify-between text-md text-white">
          <li>
